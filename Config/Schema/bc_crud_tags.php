<?php
class BcCrudTagsSchema extends CakeSchema {

	public $file = 'bc_crud_tags.php';
	...
	public $bc_crud_tags = array(
		...
		'bc_crud_tag_group_id' => array('type' => 'integer', 'null' => true, 'default' => null, 'unsigned' => false),
