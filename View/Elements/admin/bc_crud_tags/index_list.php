			...
			<th class="bca-table-listup__thead-th">
				<?php
					echo $this->Paginator->sort(
						'name',
						[
							'asc' => '<i class="bca-icon--asc"></i>'. __d('baser', 'タグ名'),
							'desc' => '<i class="bca-icon--desc"></i>'. __d('baser', 'タグ名'),
						],
						[
							'escape' => false,
							'class' => 'btn-direction bca-table-listup__a',
			...
			<th class="bca-table-listup__thead-th">
				...
				<?php
					echo $this->Paginator->sort(
						'title',
						[
							'asc' => '<i class="bca-icon--asc"></i>'. __d('baser', 'タグタイトル'),
							'desc' => '<i class="bca-icon--desc"></i>'. __d('baser', 'タグタイトル'),
						],
						[
							'escape' => false,
							'class' => 'btn-direction bca-table-listup__a',
...
<?php
	if (!empty($posts)):
		foreach ($posts as $data):
			$this->BcBaser->element('bc_crud_tags/index_row', ['data' => $data]);
		endforeach;
	else:
?>
		<tr>
