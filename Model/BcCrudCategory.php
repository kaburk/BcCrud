<?php
class BcCrudCategory extends BcCrudAppModel {
	...
	public function __construct($id = false, $table = null, $ds = null) {
		...
		$this->validate = [
			'name' => [
				[
					'rule' => ['notBlank'],
					'message' => __d('baser', 'カテゴリ名を入力してください。'),
					'required' => true,
				],
				[
					'rule' => 'alphaNumericDashUnderscore',
					'message' => __d('baser', 'カテゴリ名は半角のみで入力してください。'),
				],
				[
					'rule' => ['isUnique'],
				...
				[
					'rule' => ['maxLength', 255],
					'message' => __d('baser', 'カテゴリ名は255文字以内で入力してください。'),
				],
			],
			'title' => [
				[
					'rule' => ['notBlank'],
					'message' => __d('baser', 'カテゴリタイトルを入力してください。'),
					'required' => true,
				],
				[
					'rule' => ['maxLength', 255],
					'message' => __d('baser', 'カテゴリタイトルは255文字以内で入力してください。'),
				],
			],
			'status' => [
				[
